...
const char log_tag_const_i_MULTI_CONN AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_d_MULTI_CONN AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_w_MULTI_CONN AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_e_MULTI_CONN AT(.LOG_TAG_CONST) = 0;

const char log_tag_const_v_COMM_EDR AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_i_COMM_EDR AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_d_COMM_EDR AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_w_COMM_EDR AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_e_COMM_EDR AT(.LOG_TAG_CONST) = 0;
...
const char log_tag_const_i_EDR_EM AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_d_EDR_EM AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_w_EDR_EM AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_e_EDR_EM AT(.LOG_TAG_CONST) = 0;
