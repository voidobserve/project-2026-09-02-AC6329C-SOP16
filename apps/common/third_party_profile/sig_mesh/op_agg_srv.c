...
#pragma bss_seg(".ble_mesh_opaggsrv_bss")
#pragma data_seg(".ble_mesh_opaggsrv_data")
#pragma const_seg(".ble_mesh_opaggsrv_const")
#pragma code_seg(".ble_mesh_opaggsrv_code")
#endif
