...
#pragma bss_seg(".ble_mesh_sarcfgcli_bss")
#pragma data_seg(".ble_mesh_sarcfgcli_data")
#pragma const_seg(".ble_mesh_sarcfgcli_const")
#pragma code_seg(".ble_mesh_sarcfgcli_code")
#endif
...
s32_t bt_mesh_sar_cfg_cli_timeout_get(void)
{
    return cli->timeout;
}

void bt_mesh_sar_cfg_cli_timeout_set(s32_t timeout)
{
    cli->timeout = timeout;
}
...
int bt_mesh_sar_cfg_cli_transmitter_get(u16_t net_idx, u16_t addr,
                                        struct bt_mesh_sar_tx *rsp)
{
...
int bt_mesh_sar_cfg_cli_transmitter_set(u16_t net_idx, u16_t addr,
...
int bt_mesh_sar_cfg_cli_receiver_get(u16_t net_idx, u16_t addr,
                                     struct bt_mesh_sar_rx *rsp)
{
...
int bt_mesh_sar_cfg_cli_receiver_set(u16_t net_idx, u16_t addr,
