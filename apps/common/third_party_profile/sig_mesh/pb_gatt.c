...
#pragma bss_seg(".ble_mesh_pbgatt_bss")
#pragma data_seg(".ble_mesh_pbgatt_data")
#pragma const_seg(".ble_mesh_pbgatt_const")
#pragma code_seg(".ble_mesh_pbgatt_code")
#endif
