...
#pragma bss_seg(".ble_mesh_opaggcli_bss")
#pragma data_seg(".ble_mesh_opaggcli_data")
#pragma const_seg(".ble_mesh_opaggcli_const")
#pragma code_seg(".ble_mesh_opaggcli_code")
#endif
...
int bt_mesh_op_agg_cli_seq_start(u16_t net_idx, u16_t app_idx, u16_t dst,
                                 u16_t elem_addr)
{
...
s32_t bt_mesh_op_agg_cli_timeout_get(void)
{
    return msg_timeout;
}

void bt_mesh_op_agg_cli_timeout_set(s32_t timeout)
{
    msg_timeout = timeout;
}
...
{
    u16_t src = bt_mesh_model_elem(model)->rt->addr;
