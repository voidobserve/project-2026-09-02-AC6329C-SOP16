...
#define LOG_TAG             "[MESH-largecompdatasrv]"
...
#pragma bss_seg(".ble_mesh_largecompdatasrv_bss")
#pragma data_seg(".ble_mesh_largecompdatasrv_data")
#pragma const_seg(".ble_mesh_largecompdatasrv_const")
#pragma code_seg(".ble_mesh_largecompdatasrv_code")
#endif
