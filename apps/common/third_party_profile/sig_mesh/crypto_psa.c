...
#pragma bss_seg(".ble_mesh_cryptopsa_bss")
#pragma data_seg(".ble_mesh_cryptopsa_data")
#pragma const_seg(".ble_mesh_cryptopsa_const")
#pragma code_seg(".ble_mesh_cryptopsa_code")
#endif
