...
typedef enum bt_mesh_dfu_iter(*bt_mesh_dfu_img_cb_t)(
    struct bt_mesh_dfu_cli *cli, struct bt_mesh_msg_ctx *ctx, u8_t idx,
    u8_t total, const struct bt_mesh_dfu_img *img, void *cb_data);
 ...
 */
void bt_mesh_dfu_cli_timeout_set(s32_t timeout);
