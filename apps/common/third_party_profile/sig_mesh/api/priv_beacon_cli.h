...
struct bt_mesh_priv_beacon_cli_cb {
     ...
     */
    void (*priv_beacon_status)(struct bt_mesh_priv_beacon_cli *cli, u16_t addr,
     ...
     */
    void (*priv_gatt_proxy_status)(struct bt_mesh_priv_beacon_cli *cli, u16_t addr,
                                   u8_t gatt_proxy);
     ...
     */
    void (*priv_node_id_status)(struct bt_mesh_priv_beacon_cli *cli, u16_t addr,
 ...
 */
int bt_mesh_priv_beacon_cli_set(u16_t net_idx, u16_t addr,
 ...
 *  @return 0 on success, or (negative) error code otherwise.
 */
int bt_mesh_priv_beacon_cli_get(u16_t net_idx, u16_t addr,
                                struct bt_mesh_priv_beacon *val);
 ...
 *  @return 0 on success, or (negative) error code otherwise.
 */
int bt_mesh_priv_beacon_cli_gatt_proxy_set(u16_t net_idx, u16_t addr,
        u8_t val, u8_t *rsp);
 ...
 *  @return 0 on success, or (negative) error code otherwise.
 */
int bt_mesh_priv_beacon_cli_gatt_proxy_get(u16_t net_idx, u16_t addr,
        u8_t *val);
 ...
 *  @return 0 on success, or (negative) error code otherwise.
 */
int bt_mesh_priv_beacon_cli_node_id_get(u16_t net_idx, u16_t addr,
                                        u16_t key_net_idx,
                                        struct bt_mesh_priv_node_id *val);
