...
struct bt_mesh_dfd_srv_cb {
    ...
    int (*start_oob_upload)(struct bt_mesh_dfd_srv *srv,
                            const struct bt_mesh_dfu_slot *slot,
                            const char *uri, u8_t uri_len,
                            const u8_t *fwid, u16_t fwid_len);
     ...
     */
    u8_t (*oob_progress_get)(struct bt_mesh_dfd_srv *srv,
                             const struct bt_mesh_dfu_slot *slot);
#endif /* CONFIG_BT_MESH_DFD_SRV_OOB_UPLOAD */
...
struct bt_mesh_dfd_srv {
    ...
    struct {
        ...
        struct {
            u8_t uri_len;
            u8_t uri[CONFIG_BT_MESH_DFU_URI_MAXLEN];
            u16_t current_fwid_len;
            u8_t current_fwid[CONFIG_BT_MESH_DFU_FWID_MAXLEN];
