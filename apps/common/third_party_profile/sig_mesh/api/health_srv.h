...
struct bt_mesh_health_srv_cb {
     ...
     */
    int (*fault_get_cur)(const struct bt_mesh_model *model, u8_t *test_id,
     ...
     *  @return 0 on success, or (negative) error code otherwise.
     */
    int (*fault_get_reg)(const struct bt_mesh_model *model, u16_t company_id,
     ...
     *  @return 0 on success, or (negative) error code otherwise.
     */
    int (*fault_clear)(const struct bt_mesh_model *model, u16_t company_id);
     ...
     */
    int (*fault_test)(const struct bt_mesh_model *model, u8_t test_id,
                      u16_t company_id);
...
#define BT_MESH_HEALTH_TEST_INFO(cid, tests...)                                \
	BT_BYTES_LIST_LE16(cid), sizeof((u8_t[]){ tests }), tests
