...
struct bt_mesh_health_cli {
    ...
    /** Publication data */
    u8_t pub_data[BT_MESH_MODEL_BUF_LEN(BT_MESH_MODEL_OP_2(0x80, 0x32), 3)];
     ...
     */
    void (*period_status)(struct bt_mesh_health_cli *cli, u16_t addr,
                          u8_t divisor);
     ...
     */
    void (*attention_status)(struct bt_mesh_health_cli *cli, u16_t addr,
                             u8_t attention);
     ...
     */
    void (*fault_status)(struct bt_mesh_health_cli *cli, u16_t addr,
...
int bt_mesh_health_cli_fault_clear_unack(struct bt_mesh_health_cli *cli,
        struct bt_mesh_msg_ctx *ctx, u16_t cid);
...
int bt_mesh_health_cli_attention_set_unack(struct bt_mesh_health_cli *cli,
        struct bt_mesh_msg_ctx *ctx, u8_t attention);
