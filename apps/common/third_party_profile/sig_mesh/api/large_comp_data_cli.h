...
struct bt_mesh_large_comp_data_cli_cb {
     ...
     */
    void (*large_comp_data_status)(struct bt_mesh_large_comp_data_cli *cli, u16_t addr,
     ...
     *  @param rsp         Response received from the server.
     */
    void (*models_metadata_status)(struct bt_mesh_large_comp_data_cli *cli, u16_t addr,
                                   struct bt_mesh_large_comp_data_rsp *rsp);
};
