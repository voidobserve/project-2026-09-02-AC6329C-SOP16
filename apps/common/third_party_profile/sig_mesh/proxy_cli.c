...
#pragma bss_seg(".ble_mesh_proxycli_bss")
#pragma data_seg(".ble_mesh_proxycli_data")
#pragma const_seg(".ble_mesh_proxycli_const")
#pragma code_seg(".ble_mesh_proxycli_code")
#endif
...
static struct bt_mesh_proxy_server *find_proxy_srv(u16_t net_idx,
...
static bool proxy_srv_check_and_get(struct bt_mesh_subnet *sub, const u8_t *net_id,
...
static bool is_hash_equal(struct bt_mesh_subnet *sub, struct find_net_id *res, u8_t idx)
{
    int err;
    u8_t in[16], out[16];
...
static void handle_net_id(u8_t type, const struct bt_le_scan_recv_info *info,
...
int bt_mesh_proxy_connect(u16_t net_idx)
{
    struct bt_mesh_proxy_server *srv;
...
int bt_mesh_proxy_disconnect(u16_t net_idx)
{
    int err;
    struct bt_mesh_proxy_server *srv;
...
bool bt_mesh_proxy_cli_is_connected(u16_t net_idx)
{
