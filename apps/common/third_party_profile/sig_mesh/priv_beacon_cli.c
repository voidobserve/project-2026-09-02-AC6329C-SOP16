...
#define LOG_TAG             "[MESH-privbeaconcli]"
...
#pragma bss_seg(".ble_mesh_privbeaconcli_bss")
#pragma data_seg(".ble_mesh_privbeaconcli_data")
#pragma const_seg(".ble_mesh_privbeaconcli_const")
#pragma code_seg(".ble_mesh_privbeaconcli_code")
#endif
...
int bt_mesh_priv_beacon_cli_set(u16_t net_idx, u16_t addr, struct bt_mesh_priv_beacon *val,
                                struct bt_mesh_priv_beacon *rsp)
{
...
int bt_mesh_priv_beacon_cli_get(u16_t net_idx, u16_t addr, struct bt_mesh_priv_beacon *val)
{
    struct bt_mesh_msg_ctx ctx = BT_MESH_MSG_CTX_INIT_DEV(net_idx, addr);
    const struct bt_mesh_msg_rsp_ctx rsp_ctx = {
        .ack = &cli->ack_ctx,
...
int bt_mesh_priv_beacon_cli_gatt_proxy_set(u16_t net_idx, u16_t addr, u8_t val,
        u8_t *rsp)
{
    struct bt_mesh_msg_ctx ctx = BT_MESH_MSG_CTX_INIT_DEV(net_idx, addr);
    const struct bt_mesh_msg_rsp_ctx rsp_ctx = {
...
int bt_mesh_priv_beacon_cli_gatt_proxy_get(u16_t net_idx, u16_t addr, u8_t *val)
{
    struct bt_mesh_msg_ctx ctx = BT_MESH_MSG_CTX_INIT_DEV(net_idx, addr);
    const struct bt_mesh_msg_rsp_ctx rsp_ctx = {
        .ack = &cli->ack_ctx,
...
int bt_mesh_priv_beacon_cli_node_id_set(u16_t net_idx, u16_t addr,
...
int bt_mesh_priv_beacon_cli_node_id_get(u16_t net_idx, u16_t addr, u16_t key_net_idx,
                                        struct bt_mesh_priv_node_id *val)
{
    struct bt_mesh_msg_ctx ctx = BT_MESH_MSG_CTX_INIT_DEV(net_idx, addr);
    const struct bt_mesh_msg_rsp_ctx rsp_ctx = {
